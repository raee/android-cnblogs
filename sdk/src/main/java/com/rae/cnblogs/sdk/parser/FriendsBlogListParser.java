...
public class FriendsBlogListParser extends BlogListParser {
    ...
    public FriendsBlogListParser(ApiUiArrayListener<BlogBean> listener) {
        super(listener);
    }
    ...
    protected void onParseHtmlDocument(Document document) {
        ...
        for (Element element : elements) {
            ...
            String id = Utils.getNumber(element.select("id").text());
            ...
            String date = Utils.getDate(element.select(".updated").text()); // 发布时间
