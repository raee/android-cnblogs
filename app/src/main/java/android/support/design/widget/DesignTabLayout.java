 ...
 */
@ViewPager.DecorView
public class DesignTabLayout extends HorizontalScrollView {
    ...
    /**
     * Gravity used to fill the {@link DesignTabLayout} as much as possible. This option only takes effect
    ...
    /**
     * Gravity used to lay out the tabs in the center of the {@link DesignTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    public DesignTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // rae attrs
        TypedArray array = context.obtainStyledAttributes(attrs, com.rae.cnblogs.R.styleable.DesignTabLayout);
        mTabStrip.setIndicatorWidth(array.getDimensionPixelSize(com.rae.cnblogs.R.styleable.DesignTabLayout_tabIndicatorWidth, 0));
        array.recycle();
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<DesignTabLayout> mTabLayoutRef;
