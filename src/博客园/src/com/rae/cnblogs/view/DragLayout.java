...
public class DragLayout extends FrameLayout {
	...
	private ContentRelativeLayout		vg_main;
	...
	protected void onFinishInflate() {
		...
		vg_main = (ContentRelativeLayout) getChildAt(isShowShadow ? 2 : 1);
	...
	private Integer evaluate(float fraction, Object startValue, Integer endValue) {
		...
		return (int) ((startA + (int) (fraction * (endA - startA))) << 24) | (int) ((startR + (int) (fraction * (endR - startR))) << 16)
